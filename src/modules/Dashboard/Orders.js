...
const rows = [
  createData(0, '16 Mar, 2020', 'Christmas Wish', 'christmas, employee, customer', 'Completed', 300),
  createData(1, '21 Sep, 2020', 'New Year', 'new year, employee', 'Completed', 600),
  createData(2, '12 December, 2020', 'Promotion', 'Promo, customers', 'Completed', 800),
  createData(3, '16 Jan, 2021', 'Bonus Announcement', 'bonus, employee', 'Completed', 1200),
