    ...
    <React.Fragment>
      ...
      <div className="mb-2">
        <form onSubmit={handleSubmit((data) => console.log(data))}>
          <label class="form-label mb-1" for="fname">First name:</label><br/>
          <TextField inputRef={register} variant="outlined" name="fname" fullWidth className="bg-white mb-2"/>
          <label class="form-label mb-1" for="lname">Last name:</label>
          ...
          <label class="form-label mb-1" for="Tags">Tags:</label>
